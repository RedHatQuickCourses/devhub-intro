...
This course is the first in a series of 3 courses about Red Hat Developer Hub (RHDH). This course provides a basic introduction to the features and the architecture of the product.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devhub-intro.git
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/devhub-intro

# Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devhub-intro/issues

...
For advanced debugging, it links directly to the OpenShift Pipelines console of OpenShift.
...
It links to the ArgoCD UI for advanced debugging and inspection
